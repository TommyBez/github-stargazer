  ...
  return (
    <Popover>
      <PopoverTrigger
        ...
        className={cn(
          "relative size-7 overflow-hidden rounded-full border border-border shadow-sm outline-none ring-offset-background transition-transform duration-150 ease-out motion-safe:[@media(hover:hover)]:hover:scale-110 active:scale-95 focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2",
          className,
        )}
        style={{
